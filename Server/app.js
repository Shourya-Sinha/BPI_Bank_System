...
app.use(
  helmet.contentSecurityPolicy({
    directives: {
      ...
      connectSrc: ["'self'", "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://api.iconify.design", "https://api.simplesvg.com", "https://api.unisvg.com","https://bpi-bank-system.onrender.com"],
    },
  })
);
app.use(
