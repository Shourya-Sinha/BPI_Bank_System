...
import { ArrowsLeftRight, CaretDown, CaretUp, Wallet } from "phosphor-react";
import {
  CheckBox,
    ...
    >
      <Box sx={{ width: "100%" }}>
          ...
          <Box sx={{ paddingX: 2, backgroundColor: "#fff" }}>
            ...
            >
              <Stack direction={"row"} alignItems={"center"} spacing={2}>
                ...
                <Typography variant="caption"> {userBnakDetails?.accountNumber
                        ? userBnakDetails?.accountNumber
                        : "N/A"}</Typography>
              </Stack>
              <Stack spacing={1}>
                <Typography variant="body2">Account balance</Typography>
                <Typography variant="caption"> {userBnakDetails?.otherDeatils?.balance
                        ? userBnakDetails?.otherDeatils?.balance
                        : "N/A"}</Typography>
              </Stack>
            </Stack>
        ...
        >
          ...
          >
            <Stack>
              <Typography variant="subtitle2"  sx={{ textTransform: "uppercase" }}> {userBnakDetails?.otherDeatils?.accountType
                        ? userBnakDetails?.otherDeatils?.accountType
                        : "N/A"}</Typography>
              <Typography> {userBnakDetails?.accountNumber
                        ? userBnakDetails?.accountNumber
                        : "N/A"}</Typography>
            </Stack>
            <Stack>
        ...
        >
          ...
          >
            ...
            >
              <ArrowsLeftRight style={{ color: "#20C997", fontSize: 22 }} />
            </Stack>
...
<TextField
            ...
            <Box sx={{paddingY:2 }}> 
               <Link sx={{color:'#20c997',fontWeight:600,textDecoration:'underline'}}>Do you have a QR code?</Link>
            </Box>
          </Box>
        </Box>
        ...
        >
          ...
          <Divider />
          <Box sx={{ maxWidth: 500, marginTop: 2 ,display:'flex',alignItems:'center',flexDirection:'row'}}>
          <Stack
              sx={{
                padding: 2.2,
                backgroundColor: "#eeeeee",
            ...
            />
             ...
             <Box sx={{marginTop:2,maxWidth:500,display:'flex',justifyContent:'flex-end'}}>
              <Button variant="contained" sx={{paddingX:5,borderRadius:0.5}} onClick={handleTransactions}>
